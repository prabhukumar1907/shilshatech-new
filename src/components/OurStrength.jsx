...
const OurStrength = () => {
  return (
    ...
    >
      <div
        className="absolute top-1/4 left-0 w-125 h-125 bg-[#286b94]/15 rounded-full blur-[140px] pointer-events-none"
        style={{ willChange: "transform", transform: "translateZ(0)" }}
      />
      <div
        className="absolute bottom-10 right-0 w-100 h-100 bg-[#6ea1ff]/10 rounded-full blur-[120px] pointer-events-none"
        style={{ willChange: "transform", transform: "translateZ(0)" }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-5 order-1 lg:order-2 flex justify-center">
            <div className="relative group">
              <div
                className="absolute -inset-1 rounded-3xl opacity-30 group-hover:opacity-60 transition-opacity duration-500 blur-xl"
                style={{
                  background: `linear-gradient(135deg, ${theme.primary}, ${theme.glow})`,
                }}
              />

              <div className="relative rounded-3xl border p-4 sm:p-6 backdrop-blur-xl transition-colors duration-300 bg-white/80 border-slate-200 shadow-xl shadow-slate-200/50 dark:bg-[#0b1528]/80 dark:border-blue-500/20 dark:shadow-[0_16px_40px_-10px_rgba(0,0,0,0.8)]">
                <img
                  src={strengthImg}
