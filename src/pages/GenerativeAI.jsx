        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            >
              ...
              >
                <Sparkles size={16} className="shrink-0 animate-pulse" style={{ color: brandTheme.electricCyan }} />
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] bg-linear-to-r from-slate-900 via-slate-800 to-blue-950 dark:from-white dark:via-slate-100 dark:to-blue-200 bg-clip-text text-transparent">
                Enterprise Generative AI Development & Creative Automation
              </h1>
              
              <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg leading-relaxed max-w-2xl font-normal">
                Shilsha Technologies architects bespoke generative AI models, multi-modal content pipelines, and automated text-to-code environments to revolutionize your core workflows.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-3">
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
                  ...
                  >
                    <span>Build GenAI Solutions</span>
                    <ArrowRight size={16} />
                  </Link>
                </motion.div>
                ...
                <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 font-medium px-3 py-2 rounded-lg bg-slate-100/80 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50">
                  ...
                  <span>Production-Grade Foundation Models</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full max-w-md aspect-square rounded-3xl border border-blue-200/50 dark:border-blue-500/20 bg-linear-to-br from-blue-50/50 via-white to-slate-100 dark:from-[#070d18] dark:via-[#0b1528] dark:to-[#0f2035] p-8 flex flex-col items-center justify-center shadow-inner group overflow-hidden">
                ...
                <div className="relative z-10 p-6 rounded-2xl bg-white/80 dark:bg-[#0b1528]/90 border border-blue-100 dark:border-blue-500/30 shadow-2xl mb-4 group-hover:scale-105 transition-transform duration-500">
                  <Wand2 style={{ color: brandTheme.primaryBlue }} size={72} />
                </div>
                
                <div className="relative z-10 text-center space-y-1">
                  <div className="text-sm font-bold tracking-wide text-slate-800 dark:text-slate-200">Creative Automation Core</div>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Custom LLMs • Multi-Modal • Secure RAG</p>
                </div>
                ...
                <div className="absolute top-4 left-4 px-3 py-1.5 rounded-xl bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-md flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold text-slate-700 dark:text-slate-300">Infinite Scale</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            >
              Transforming Creativity and Workflow Automation with GenAI
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-4">
            <div className="p-8 sm:p-10 rounded-3xl bg-white dark:bg-[#0b1528] border border-slate-200/80 dark:border-blue-500/20 shadow-xl space-y-5 flex flex-col justify-center">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
                Generative AI unlocks unprecedented creative and analytical potential across industries. Shilsha Technologies builds production-ready generative architectures that automate repetitive asset creation, synthesize massive data points, and deliver bespoke user experiences at scale.
              </p>
            </div>
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-white dark:bg-[#0b1528] border border-slate-200/80 dark:border-blue-500/20 shadow-xl space-y-5 flex flex-col justify-center">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
                Whether you want to launch specialized conversational interfaces, streamline asset production, or integrate state-of-the-art foundation models into existing applications, our engineers deliver secure, scalable results.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 
              ...
              style={{ color: brandTheme.primaryBlue }}
            >
              Drive Infinite Scale with Secure Generative Models
            </h2>
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Partner with Shilsha Technologies today to harness the absolute frontier of generative artificial intelligence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-bold text-slate-900 dark:text-white">Rigid Guardrails & Encryption</h4>
                <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
                  We implement rigid guardrails, hallucination reduction tactics, and enterprise-grade encryption to ensure your generative workflows remain precise, compliant, and completely secure.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-bold text-slate-900 dark:text-white">Frontier AI Engineering</h4>
                <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
                  Leverage our cutting-edge domain expertise to build proprietary generative applications tailored specifically to your enterprise infrastructure and strategic vision.
                </p>
              </div>
            </motion.div>
          </div>
