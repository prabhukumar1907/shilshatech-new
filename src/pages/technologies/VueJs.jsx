      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl border border-slate-200/80 dark:border-blue-500/20 bg-white dark:bg-[#0b1528] p-8 sm:p-12 shadow-xl overflow-hidden mb-12">
          <div 
            ...
            style={{ background: `linear-gradient(90deg, #10b981, ${theme.glow})` }}
          />
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="flex flex-col gap-4">
              <div className="inline-flex items-center gap-2 w-fit px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20">
                <SiVuedotjs size={14} className="shrink-0" />
                <span>Vue.js Development Services</span>
              </div>
              <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
                Progressive Vue.js Application Development
              </h1>
              <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
                Build high-performing, scalable, and maintainable user interfaces with our expert Vue.js development solutions. We create lightweight, modern web applications customized for your enterprise needs.
              </p>
              <div className="flex flex-wrap gap-3 pt-2">
                <Link
                  ...
                  style={{ background: `linear-gradient(90deg, #10b981, ${theme.secondary})` }}
                >
            ...
            <div className="flex justify-center">
              <div className="p-8 rounded-2xl border border-slate-100 dark:border-blue-500/10 bg-slate-50 dark:bg-[#070d18] flex items-center justify-center shadow-inner">
                <SiVuedotjs className="text-emerald-500 animate-pulse" size={120} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-blue-500/20 bg-white dark:bg-[#0b1528] shadow-sm">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              Leverage Vue's reactivity system and lightweight virtual DOM for exceptionally fast rendering and optimal execution speeds.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-blue-500/20 bg-white dark:bg-[#0b1528] shadow-sm">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              Encapsulated components ensure robust code organization, seamless reusability, and simplified maintenance throughout lifecycle phases.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-blue-500/20 bg-white dark:bg-[#0b1528] shadow-sm">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              Easily integrate with state management libraries like Pinia or Vuex to build large-scale enterprise single-page applications.
            </p>
          </div>
        </div>
