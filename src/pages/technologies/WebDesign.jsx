...
import { Layout, Monitor, Code, ArrowRight, Globe } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            ...
            style={{
              background: `linear-gradient(90deg, #3B82F6, ${theme.glow})`,
            }}
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight">
                Modern Web Design & Responsive Development Services in India
              </h1>
              <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
                Shilsha Technologies builds blazing-fast, responsive, and
                visually stunning websites tailored to convert visitors into
                loyal customers.
              </p>
              <motion.div
              ...
              >
                <Link
                  ...
                  style={{
                    background: `linear-gradient(90deg, #3B82F6, ${theme.secondary})`,
                  }}
                >
            ...
            >
              <div className="p-10 rounded-2xl border border-slate-100 dark:border-blue-500/10 bg-slate-50 dark:bg-[#070d18] flex items-center justify-center shadow-inner relative group">
                ...
                <Monitor
                  className="text-[#3B82F6] dark:text-[#93c5fd] transition-transform duration-500 group-hover:scale-110"
                  size={120}
                />
              </div>
            </motion.div>
          ...
          {[
            {
              ...
              desc: "Ensure pixel-perfect rendering across desktops, tablets, and mobile devices.",
            },
            {
              icon: <Code size={20} />,
              title: "Performance & SEO Optimized",
              desc: "Write clean, fast-loading code optimized for search engine visibility.",
            },
            {
              icon: <Layout size={20} />,
              title: "Custom UI Architecture",
              desc: "Design unique, modern landing pages and corporate websites that reflect your brand.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <div className="lg:col-span-12 space-y-8">
            ...
            >
              Establish a Powerful Digital Presence with Expert Web Design
            </h2>
            <div
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] backdrop-blur-xl border border-slate-200 dark:border-blue-500/20 shadow-xl space-y-6">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Your website is your digital storefront. Shilsha Technologies
                designs and develops engaging, high-performance websites that
                captivate visitors and drive business growth.
              </p>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Partner with our web designers today to launch your next
      ...
      <section className="py-16 px-6 bg-slate-100/60 dark:bg-[#0b1528]/40 border-y border-slate-200 dark:border-blue-500/20">
        <div className="max-w-7xl mx-auto space-y-8">
          <motion.h2
            ...
            style={{ color: brandTheme.primaryBlue }}
          >
            Deliver Exceptional Web Experiences on Every Screen
          </motion.h2>
          <div className="space-y-6 text-slate-600 dark:text-slate-300 text-base sm:text-lg leading-relaxed">
            ...
            >
              As a premier web development partner, Shilsha Technologies
              combines creative web design with robust front-end engineering to
              ensure superior speed and responsiveness.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] border border-slate-200 dark:border-blue-500/20 shadow-lg transition-transform duration-300"
            >
              Contact our design team today to build a website that drives real
              results.
            </motion.p>
          </div>
        </div>
