...
import { Smartphone, Layers, Zap, ArrowRight, Tablet } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            ...
            style={{
              background: `linear-gradient(90deg, #10B981, ${theme.glow})`,
            }}
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight">
                Mobile App UI/UX Design & App Prototyping Services in India
              </h1>
              <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
                Shilsha Technologies designs engaging iOS and Android mobile app
                interfaces focused on seamless navigation, retention, and
                delight.
              </p>
              <motion.div
              ...
              >
                <Link
                  ...
                  style={{
                    background: `linear-gradient(90deg, #10B981, ${theme.secondary})`,
                  }}
                >
                  <span>Hire App Designers</span>
                  <ArrowRight size={15} />
                </Link>
              </motion.div>
            </motion.div>
            ...
            >
              <div className="p-10 rounded-2xl border border-slate-100 dark:border-emerald-500/10 bg-slate-50 dark:bg-[#070d18] flex items-center justify-center shadow-inner relative group">
                ...
                <Tablet
                  className="text-[#10B981] dark:text-[#6ee7b7] transition-transform duration-500 group-hover:scale-110"
                  size={120}
                />
              </div>
            </motion.div>
          ...
          {[
            {
              ...
              desc: "Craft platform-compliant Human Interface and Material Design guidelines.",
            },
            {
              icon: <Zap size={20} />,
              title: "Interactive Prototyping",
              desc: "Test gesture flows and touch animations before development begins.",
            },
            {
              icon: <Layers size={20} />,
              title: "High Retention UI",
              desc: "Design onboarding flows and user journeys engineered for high engagement.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <div className="lg:col-span-12 space-y-8">
            ...
            >
              Build Engaging Mobile Experiences with Expert App Design
            </h2>
            <div
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] backdrop-blur-xl border border-slate-200 dark:border-emerald-500/20 shadow-xl space-y-6">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Mobile applications require intuitive touch navigation and
                lightning-fast feedback loops. Shilsha Technologies designs
                world-class iOS and Android interfaces that keep users coming
                back.
              </p>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Partner with our mobile app designers today to bring your app
                concept to life!
              </p>
            </div>
          </div>
      ...
      <section className="py-16 px-6 bg-slate-100/60 dark:bg-[#0b1528]/40 border-y border-slate-200 dark:border-emerald-500/20">
        <div className="max-w-7xl mx-auto space-y-8">
          <motion.h2
            ...
            style={{ color: brandTheme.primaryBlue }}
          >
            Create Intuitive App Interfaces Users Love
          </motion.h2>
          <div className="space-y-6 text-slate-600 dark:text-slate-300 text-base sm:text-lg leading-relaxed">
            ...
            >
              As a premier app development agency, Shilsha Technologies ensures
              that every mobile design optimizes screen real estate and
              interaction flows for maximum usability.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] border border-slate-200 dark:border-emerald-500/20 shadow-lg transition-transform duration-300"
            >
              Contact our mobile design team today to craft your next
              high-performance app interface.
            </motion.p>
          </div>
        </div>
      </section>
