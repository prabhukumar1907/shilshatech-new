...
import { PenTool, Image, Sparkles, ArrowRight, Layers } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight">
                Creative Graphic Design & Brand Identity Services in India
              </h1>
              <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
                Shilsha Technologies delivers striking visual assets, brand
                identities, and marketing creatives that make your business
          ...
          {[
            {
              ...
              desc: "Craft memorable logos, color palettes, and comprehensive brand style guides.",
            },
            {
              icon: <Image size={20} />,
              title: "Marketing Collateral",
              desc: "Design high-impact social media posts, banners, brochures, and ad creatives.",
            },
            {
              icon: <Layers size={20} />,
              title: "Print & Digital Assets",
              desc: "Produce flawless vector illustrations, packaging designs, and presentation decks.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <div className="lg:col-span-12 space-y-8">
            ...
            >
              Amplify Your Brand Story Through Powerful Visual Design
            </h2>
            <div
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] backdrop-blur-xl border border-slate-200 dark:border-purple-500/20 shadow-xl space-y-6">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Visual communication is the heartbeat of modern marketing.
                Shilsha Technologies creates captivating graphic designs that
                communicate your brand values instantly and leave a lasting
                impression on your target audience.
              </p>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Contact our creative team today to elevate your visual identity!
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <section className="py-16 px-6 bg-slate-100/60 dark:bg-[#0b1528]/40 border-y border-slate-200 dark:border-purple-500/20">
        <div className="max-w-7xl mx-auto space-y-8">
          <motion.h2
            ...
            style={{ color: brandTheme.primaryBlue }}
          >
            Create Lasting Visual Impressions Across All Media
          </motion.h2>
          <div className="space-y-6 text-slate-600 dark:text-slate-300 text-base sm:text-lg leading-relaxed">
            ...
            >
              As an expert digital agency, Shilsha Technologies integrates
              high-end graphic design with marketing strategies to ensure your
              promotional materials drive maximum engagement.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] border border-slate-200 dark:border-purple-500/20 shadow-lg transition-transform duration-300"
            >
              Connect with our designers today to bring your creative vision to
              life.
            </motion.p>
          </div>
        </div>
