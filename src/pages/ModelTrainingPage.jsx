      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 w-fit px-3 py-1 rounded-full text-xs font-semibold bg-blue-50 text-[#276ea5] dark:bg-blue-500/10 dark:text-blue-300 border border-blue-200 dark:border-blue-500/20 shadow-sm">
                <Database size={20} className="shrink-0" />
                <span>Shilsha Technologies Expert Services</span>
              </div>
              <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight">
                Custom Machine Learning Model Training & Optimization in India
              </h1>
              <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
                Shilsha Technologies engineers, trains, and fine-tunes high-performance machine learning architectures using your proprietary enterprise datasets for peak domain accuracy.
              </p>
              <motion.div 
            ...
            >
              <div className="p-10 rounded-2xl border border-slate-100 dark:border-blue-500/10 bg-slate-50 dark:bg-[#070d18] flex items-center justify-center shadow-inner relative group">
                ...
                <Workflow className="text-[#276ea5] dark:text-[#60a5fa] transition-transform duration-500 group-hover:scale-110" size={120} />
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {[
            ...
            >
              <div className="h-10 w-10 rounded-xl bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-[#276ea5] dark:text-[#60a5fa] mb-4 transition-transform duration-300 group-hover:scale-110">
                {feature.icon}
              </div>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <div className="lg:col-span-12 space-y-8">
            ...
            >
              Powering Custom Predictive Intelligence with Rigorous Model Training
            </h2>
            <div 
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] backdrop-blur-xl border border-slate-200 dark:border-blue-500/20 shadow-xl space-y-6">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Generic AI models rarely capture the subtle nuances of specific business verticals. Shilsha Technologies designs tailored machine learning lifecycles, taking raw data through rigorous preprocessing, feature engineering, and model training phases to deliver maximum predictive accuracy.
              </p>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base sm:text-lg">
                Whether you are building recommendation engines, automated anomaly detection systems, or domain-specific classification architectures, our machine learning engineers ensure robust performance under real-world operational loads.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <section className="py-16 px-6 bg-slate-100/60 dark:bg-[#0b1528]/40 border-y border-slate-200 dark:border-blue-500/20">
        <div className="max-w-7xl mx-auto space-y-8">
          <motion.h2 
            ...
            style={{ color: brandTheme.primaryBlue }}
          >
            Drive Precise Results with Optimized Model Performance
          </motion.h2>
          <div className="space-y-6 text-slate-600 dark:text-slate-300 text-base sm:text-lg leading-relaxed">
            ...
            >
              We implement advanced hyperparameter tuning, cross-validation protocols, and robust overfitting controls to guarantee that your deployed models generalize seamlessly on unseen live data.
            </motion.p>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="p-8 rounded-3xl bg-white dark:bg-[#0b1528] border border-slate-200 dark:border-blue-500/20 shadow-lg transition-transform duration-300"
            >
              Partner with Shilsha Technologies today to turn dormant enterprise datasets into high-precision machine learning assets.
            </motion.p>
          </div>
        </div>
      </section>
