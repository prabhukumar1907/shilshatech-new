...
const engagementModels = [
  {
    title: "Dedicated AI/ML Engineering Team",
    desc: "Scale your intelligence initiatives with senior data scientists and machine learning engineers dedicated exclusively to your roadmap.",
    icon: Users,
    badge: "Most Popular",
  },
  {
    title: "Custom LLM & GenAI Solutions",
    desc: "End-to-end development of custom generative AI models, RAG pipelines, fine-tuning, and enterprise automation.",
    icon: Workflow,
    badge: "Turnkey Solution",
  },
  {
    title: "Hourly / Model Augmentation",
    desc: "Flexible engagement model ideal for model optimization, prompt engineering, data pipeline auditing, and specific AI gaps.",
    icon: Clock,
    badge: "Flexible",
  },
];
...
const coreExpertise = [
  { label: "Generative AI & LLMs", desc: "OpenAI, Anthropic, LangChain, LlamaIndex, RAG Pipelines", icon: Bot },
  { label: "Machine Learning & Deep Learning", desc: "PyTorch, TensorFlow, Scikit-Learn, Neural Networks", icon: Brain },
  { label: "Data Engineering & MLOps", desc: "Apache Kafka, MLflow, Docker, Kubernetes, Vector DBs", icon: Database },
  { label: "AI Infrastructure & Cloud", desc: "AWS SageMaker, Google Vertex AI, GPU Clusters", icon: Cpu },
];

const comparisonData = [
  {
    feature: "AI Talent Vetting",
    shilsha: "Top 1% AI scientists with proven production models",
    freelance: "Theoretical knowledge without deployment experience",
    agency: "Outsourced junior data labelers",
  },
  {
    feature: "Deployment Speed",
    shilsha: "Ready to deploy within 24 to 48 hours",
    freelance: "Weeks of vetting ML math and code proficiency",
    agency: "Lengthy enterprise onboarding cycles",
  },
  {
    feature: "Model Security & Privacy",
    shilsha: "Enterprise-grade data security & private LLM hosting",
    freelance: "Vulnerable to data leaks and public API risks",
    agency: "Standard boilerplate policies",
  },
  {
    feature: "R&D to Production",
    shilsha: "Seamless transition from proof-of-concept to scalable cloud deployment",
    freelance: "Stuck in endless Jupyter notebook prototypes",
    agency: "Over-engineered bloated systems",
  },
];

const faqs = [
  {
    q: "How fast can I hire an AI/ML Developer from Shilsha Technologies?",
    a: "We can onboard vetted senior AI/ML engineers and data scientists within 24 to 48 hours of initial requirement alignment.",
  },
  {
    q: "Do you build custom LLM and RAG solutions for enterprises?",
    a: "Yes! We specialize in building secure Retrieval-Augmented Generation (RAG) systems, custom model fine-tuning, and intelligent autonomous AI agents tailored to your proprietary data.",
  },
  {
    q: "Can I interview the AI engineers before hiring?",
    a: "Absolutely. We encourage direct technical interviews so you can evaluate their expertise in machine learning frameworks, system architecture, and domain alignment.",
  },
  {
    q: "How do you protect our sensitive corporate data when building AI models?",
    a: "We enforce rigorous enterprise security protocols, utilize private vector databases, and can deploy models securely within your own cloud infrastructure (AWS/GCP/Azure) to ensure absolute data privacy.",
  },
];
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden px-6 pt-32 pb-24 transition-colors duration-500 bg-slate-50 text-slate-900 dark:bg-[#070d18] dark:text-slate-100 selection:bg-blue-500 selection:text-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl w-full flex flex-col items-center">
        ...
        >
          ...
          <span>Hire Developers &gt; AI/ML Developer</span>
        </motion.div>

        {/* Main Header & Hero Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full items-start">
          ...
          >
            ...
            <p className="mt-5 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
              Accelerate your digital transformation with vetted, world-class artificial intelligence and machine learning experts from Shilsha Technologies. We build intelligent automation, custom generative AI models, and robust RAG architectures tailored to your business goals.
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-4 rounded-2xl border border-slate-200/80 bg-white/80 dark:border-blue-500/20 dark:bg-[#0a1325]/80 backdrop-blur-xl shadow-lg">
                ...
                <div>
                  <h4 className="font-bold text-sm">Top 1% AI Specialists</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Production-ready engineers</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl border border-slate-200/80 bg-white/80 dark:border-blue-500/20 dark:bg-[#0a1325]/80 backdrop-blur-xl shadow-lg">
                ...
                <div>
                  <h4 className="font-bold text-sm">Custom LLM & RAG</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Secure enterprise intelligence</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <RequestForm 
            ...
            title="Request AI/ML Expert"
            subtitle="Fill out the form below and get connected with matched AI engineers in less than 24 hours."
            textareaPlaceholder="Tell us about your LLM, RAG, or machine learning needs..."
            theme={theme}
          />
        </div>
        ...
        >
          <div className="text-center max-w-2xl mx-auto mb-12">
            <div className="inline-flex items-center gap-2 rounded-xl px-3 py-1.5 text-xs font-bold bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 mb-3">
              <Award size={14} /> Flexible AI Engagement
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              Choose Your Engagement Model
            </h2>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-2">
              Whether you need specialized data scientists or an end-to-end GenAI product squad, we adapt to your goals.
            </p>
          </div>
        ...
        >
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-2">
              See why leading companies prefer Shilsha Technologies for AI/ML engineering over standard freelancers or agencies.
            </p>
          </div>
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">
              Got questions about hiring AI/ML developers? We have answers.
            </p>
          </div>
