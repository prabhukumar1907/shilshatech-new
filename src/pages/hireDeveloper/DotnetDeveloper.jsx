...
const engagementModels = [
  {
    title: "Dedicated .NET Squad",
    desc: "Scale your enterprise development capacity instantly with senior .NET Core & C# engineers dedicated exclusively to your product roadmap.",
    icon: Users,
    badge: "Most Popular",
  },
  {
    title: "Project-Based Delivery",
    desc: "End-to-end enterprise execution from architecture design to API development and SQL database optimization, managed by our technical leads.",
    icon: Workflow,
    badge: "Turnkey Solution",
  },
  {
    title: "Hourly / Staff Augmentation",
    desc: "Flexible engagement model ideal for legacy system migration, cloud refactoring, security audits, or filling specific .NET skill gaps.",
    icon: Clock,
    badge: "Flexible",
  },
];
...
const coreExpertise = [
  { label: ".NET Core & C#", desc: ".NET 8, C#, ASP.NET Core Web API, Entity Framework Core, LINQ", icon: Code2 },
  { label: "Enterprise Architecture", desc: "Microservices, Clean Architecture, CQRS, Domain-Driven Design (DDD)", icon: Terminal },
  { label: "Cloud & Database", desc: "Microsoft Azure, SQL Server, PostgreSQL, Redis, Azure DevOps", icon: Database },
  { label: "Security & DevOps", desc: "JWT / OAuth2, Docker, Kubernetes, CI/CD Pipelines, Performance Tuning", icon: Cpu },
];

const comparisonData = [
  {
    feature: "Vetting & Tech Assessment",
    shilsha: "Top 1% rigorously tested .NET & C# enterprise engineers",
...
const faqs = [
  {
    q: "How fast can I hire a .NET Developer from Shilsha Technologies?",
    a: "We can onboard vetted senior .NET and C# developers within 24 to 48 hours of initial requirement alignment.",
  },
  {
    q: "Do your .NET developers have experience with .NET Core and Azure cloud services?",
    a: "Yes! All our .NET engineers are proficient in the latest .NET ecosystems including .NET 8, ASP.NET Core, microservices architecture, and Azure cloud integration.",
  },
  {
    q: "Can I interview the .NET developers before hiring?",
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden px-6 pt-32 pb-24 transition-colors duration-500 bg-slate-50 text-slate-900 dark:bg-[#070d18] dark:text-slate-100 selection:bg-blue-500 selection:text-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl w-full flex flex-col items-center">
          ...
          >
            ...
            <span>Hire Developers &gt; Dotnet Developer</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full items-start">
            ...
            >
              ...
              <p className="mt-5 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
                Build robust enterprise applications, high-throughput APIs, and scalable cloud solutions with world-class .NET & C# talent from Shilsha Technologies. We deliver secure and high-performance software engineered for growth.
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-4 rounded-2xl border border-slate-200/80 bg-white/80 dark:border-blue-500/20 dark:bg-[#0a1325]/80 backdrop-blur-xl shadow-lg">
                  ...
                  <div>
                    <h4 className="font-bold text-sm">Top 1% .NET Talent</h4>
            ...
            <RequestForm 
              ...
              title="Request .NET Expert"
              subtitle="Fill out the form below and connect with matched .NET developers in less than 24 hours."
              textareaPlaceholder="Tell us about your .NET requirements and enterprise tech stack..."
              theme={theme}
            />
          ...
          >
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-2">
                Whether you need specialized individual contributors or an entire agile .NET unit, we adapt to your goals.
              </p>
            </div>
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">
                Got questions about hiring .NET developers? We have answers.
              </p>
            </div>
