...
// Theme configuration matching Shilsha Technologies brand colors
const theme = {
...
const engagementModels = [
  {
    title: "Dedicated Node.js Squad",
    desc: "Scale your backend engineering capacity instantly with senior Node.js & microservices developers dedicated exclusively to your product roadmap.",
    icon: Users,
    badge: "Most Popular",
  },
  {
    title: "Project-Based Delivery",
    desc: "End-to-end backend execution from architecture design to API development and database optimization, managed by our technical leads.",
    icon: Workflow,
    badge: "Turnkey Solution",
  },
  {
    title: "Hourly / Staff Augmentation",
    desc: "Flexible engagement model ideal for backend optimization, security audits, scaling bottlenecks, or filling specific backend skill gaps.",
    icon: Clock,
    badge: "Flexible",
  },
];
...
const coreExpertise = [
  { label: "Core Node.js & Frameworks", desc: "Express.js, NestJS, Fastify, Asynchronous Architecture, Event Loop", icon: Server },
  { label: "API Design & Integration", desc: "RESTful APIs, GraphQL, Microservices Architecture, WebSockets", icon: Terminal },
  { label: "Database & Caching", desc: "PostgreSQL, MongoDB, Redis, MySQL, ORMs (Prisma, Mongoose)", icon: Database },
  { label: "Security & DevOps", desc: "JWT Authentication, Docker, AWS, CI/CD Pipelines, Performance Tuning", icon: Cpu },
];

const comparisonData = [
  {
    feature: "Vetting & Tech Assessment",
    shilsha: "Top 1% rigorously tested Node.js & backend engineers",
...
const faqs = [
  {
    q: "How fast can I hire a Node.js Developer from Shilsha Technologies?",
    a: "We can onboard vetted senior Node.js and backend developers within 24 to 48 hours of initial requirement alignment.",
  },
  {
    q: "Do your Node.js developers have experience with microservices and TypeScript?",
    a: "Yes! All our backend engineers are proficient in TypeScript, NestJS/Express.js, microservices architecture, database optimization, and cloud deployment.",
  },
  {
    q: "Can I interview the Node.js developers before hiring?",
    a: "Yes, absolutely. We encourage direct technical interviews so you can assess their coding standards, problem-solving skills, and cultural compatibility.",
  },
  {
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden px-6 pt-32 pb-24 transition-colors duration-500 bg-slate-50 text-slate-900 dark:bg-[#070d18] dark:text-slate-100 selection:bg-blue-500 selection:text-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl w-full flex flex-col items-center">
          ...
          >
            ...
            <span>Hire Developers &gt; Node.js Developer</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full items-start">
            ...
            >
              ...
              <p className="mt-5 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
                Build secure, scalable, and high-performance backend systems and APIs with world-class Node.js talent from Shilsha Technologies. We power robust digital infrastructure tailored to your business needs.
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-4 rounded-2xl border border-slate-200/80 bg-white/80 dark:border-blue-500/20 dark:bg-[#0a1325]/80 backdrop-blur-xl shadow-lg">
                  ...
                  <div>
                    <h4 className="font-bold text-sm">Top 1% Backend Talent</h4>
            ...
            <RequestForm 
              ...
              title="Request Node.js Expert"
              subtitle="Fill out the form below and connect with matched backend developers in less than 24 hours."
              textareaPlaceholder="Tell us about your backend requirements and tech stack..."
              theme={theme}
            />
          ...
          >
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-2">
                Whether you need specialized individual contributors or an entire agile backend unit, we adapt to your goals.
              </p>
            </div>
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">
                Got questions about hiring Node.js developers? We have answers.
              </p>
            </div>
