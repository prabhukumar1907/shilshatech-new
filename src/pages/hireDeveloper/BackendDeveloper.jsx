...
const engagementModels = [
  {
    title: "Dedicated Backend Squad",
    desc: "Scale your backend engineering capacity instantly with senior server-side developers and architects dedicated exclusively to your product roadmap.",
    icon: Users,
    badge: "Most Popular",
  },
  {
    title: "Project-Based Delivery",
    desc: "End-to-end backend execution from architecture design to API development and secure database optimization, managed by our technical leads.",
    icon: Workflow,
    badge: "Turnkey Solution",
  },
  {
    title: "Hourly / Staff Augmentation",
    desc: "Flexible engagement model ideal for backend performance audits, database tuning, microservices scaling, or filling specific server-side skill gaps.",
    icon: Clock,
    badge: "Flexible",
  },
];
...
const coreExpertise = [
  { label: "Server-Side Languages", desc: "Node.js, Python (Django/FastAPI), Java (Spring Boot), Go, PHP", icon: Server },
  { label: "API Design & Architecture", desc: "RESTful APIs, GraphQL, Microservices, gRPC, WebSockets", icon: Terminal },
  { label: "Databases & Storage", desc: "PostgreSQL, MySQL, MongoDB, Redis, Cassandra, ORMs", icon: Database },
  { label: "Security & Infrastructure", desc: "OAuth/JWT, AWS, Docker, Kubernetes, CI/CD, Load Balancing", icon: Cpu },
];

const comparisonData = [
  {
    feature: "Vetting & Tech Assessment",
    shilsha: "Top 1% rigorously tested backend engineers",
...
const faqs = [
  {
    q: "How fast can I hire a Backend Developer from Shilsha Technologies?",
    a: "We can onboard vetted senior backend developers within 24 to 48 hours of initial requirement alignment.",
  },
  {
    q: "What tech stacks and databases do your backend developers specialize in?",
    a: "Our backend engineers are proficient across multiple stacks including Node.js, Python, Java, Go, and relational/NoSQL databases like PostgreSQL, MongoDB, and Redis.",
  },
  {
    q: "Can I interview the Backend developers before hiring?",
    a: "Yes, absolutely. We encourage direct technical interviews so you can assess their architectural design skills, coding standards, and problem-solving abilities.",
  },
  {
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden px-6 pt-32 pb-24 transition-colors duration-500 bg-slate-50 text-slate-900 dark:bg-[#070d18] dark:text-slate-100 selection:bg-blue-500 selection:text-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl w-full flex flex-col items-center">
          ...
          >
            ...
            <span>Hire Developers &gt; Backend Developer</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full items-start">
            ...
            >
              ...
              <p className="mt-5 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
                Build resilient, high-performance, and secure server-side architectures, databases, and APIs with world-class backend talent from Shilsha Technologies. We power the core engine of your digital products.
              </p>
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">
                Got questions about hiring backend developers? We have answers.
              </p>
            </div>
