...
const engagementModels = [
  {
    title: "Dedicated DevOps Squad",
    desc: "Scale your cloud architecture, CI/CD automation, and infrastructure reliability instantly with senior DevOps and SRE engineers dedicated to your roadmap.",
    icon: Users,
    badge: "Most Popular",
  },
  {
    title: "Project-Based Delivery",
    desc: "End-to-end cloud migration, automated pipeline setup, Kubernetes orchestration, and security compliance implementation, managed by our technical leads.",
    icon: Workflow,
    badge: "Turnkey Solution",
  },
  {
    title: "Hourly / Staff Augmentation",
    desc: "Flexible engagement model ideal for infrastructure audits, Kubernetes scaling, cost optimization, or filling specific DevOps skill gaps.",
    icon: Clock,
    badge: "Flexible",
  },
];
...
const coreExpertise = [
  { label: "Cloud Platforms", desc: "AWS, Google Cloud Platform (GCP), Microsoft Azure, Multi-Cloud", icon: Cloud },
  { label: "Containers & Orchestration", desc: "Docker, Kubernetes, Helm, ECS, EKS, GKE", icon: Server },
  { label: "CI/CD & Automation", desc: "GitHub Actions, GitLab CI, Jenkins, ArgoCD, CircleCI", icon: Terminal },
  { label: "Infrastructure as Code", desc: "Terraform, Ansible, CloudFormation, Pulumi, GitOps", icon: Cpu },
];

const comparisonData = [
  {
    feature: "Vetting & Tech Assessment",
    shilsha: "Top 1% rigorously tested DevOps and Cloud engineers",
    freelance: "Variable skill levels, time-consuming screening",
    agency: "Inconsistent engineer talent assignment",
  },
  {
  ...
  },
  {
    ...
    shilsha: "Instant, seamless engineer replacement at zero cost",
...
const faqs = [
  {
    q: "How fast can I hire a DevOps Engineer from Shilsha Technologies?",
    a: "We can onboard vetted senior DevOps and cloud infrastructure engineers within 24 to 48 hours of initial requirement alignment.",
  },
  {
    q: "What cloud platforms and tools do your DevOps engineers specialize in?",
    a: "Our engineers are experts across major cloud providers (AWS, GCP, Azure) and use industry-standard tooling including Kubernetes, Docker, Terraform, Ansible, GitHub Actions, and ArgoCD.",
  },
  {
    q: "Can I interview the DevOps engineers before hiring?",
    a: "Yes, absolutely. We encourage direct technical interviews so you can assess their architecture design, security practices, and troubleshooting expertise.",
  },
  {
    q: "What if I am not satisfied with the engineer's output?",
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden px-6 pt-32 pb-24 transition-colors duration-500 bg-slate-50 text-slate-900 dark:bg-[#070d18] dark:text-slate-100 selection:bg-blue-500 selection:text-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl w-full flex flex-col items-center">
          ...
          >
            ...
            <span>Hire Developers &gt; DevOps Engineer</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full items-start">
            ...
            >
              ...
              <p className="mt-5 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
                Scale your infrastructure, automate deployment pipelines, and maximize uptime with world-class DevOps and SRE talent from Shilsha Technologies. We build robust, secure, and cost-effective cloud architectures.
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-4 rounded-2xl border border-slate-200/80 bg-white/80 dark:border-blue-500/20 dark:bg-[#0a1325]/80 backdrop-blur-xl shadow-lg">
                  ...
                  <div>
                    <h4 className="font-bold text-sm">Top 1% DevOps Talent</h4>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Rigorously screened engineers</p>
                  </div>
                </div>
            ...
            <RequestForm 
              ...
              title="Request DevOps Expert"
              subtitle="Fill out the form below and connect with matched DevOps engineers in less than 24 hours."
              textareaPlaceholder="Tell us about your cloud infrastructure and DevOps requirements..."
              theme={theme}
            />
          ...
          >
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-2">
                Whether you need specialized individual contributors or an entire agile cloud unit, we adapt to your goals.
              </p>
            </div>
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">
                Got questions about hiring DevOps engineers? We have answers.
              </p>
            </div>
